...
namespace Plugins.FSignal
{
    ...
    public class FSignal : BaseSignal
    {
        ...
        public void RemoveOneshotListener(Action callback) { OnceListener -= callback; }
    ...
    public class FSignal<T> : BaseSignal
    {
        ...
        public void RemoveOneshotListener(Action<T> callback) { OnceListener -= callback; }
    ...
    public class FSignal<T, U> : BaseSignal
    {
    ...
    public class FSignal<T, U, V> : BaseSignal
    {
    ...
    public class FSignal<T, U, V, W> : BaseSignal
    {
